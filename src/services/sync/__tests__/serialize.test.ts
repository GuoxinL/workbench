...
function data(): WorkbenchData {
  return {
    version: 1,
    todos: [
      { id: 'live', title: 't', desc: '', color: 'blue', status: 'todo', due: '', noteId: '', createdAt: 1, updatedAt: 1, deleted: false },
      { id: 'fresh-tomb', title: 't', desc: '', color: 'blue', status: 'todo', due: '', noteId: '', createdAt: 1, updatedAt: 1, deleted: true },
    ],
    articles: [],
    updatedAt: 1,
  }
